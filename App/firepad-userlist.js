var FirepadUserList = (function() {
  ...
  FirepadUserList.prototype.makeUserEntryForSelf_ = function() {
    ...
    this.firebaseOn_(myUserRef.child('userId'), 'value', function (userIdSnapshot) {
        var userId = userIdSnapshot.val();
        colorDiv.style.backgroundImage = "url('https://graph.facebook.com/" +userId +"/picture')";
        colorDiv.style.backgroundSize = "contain";
    });
